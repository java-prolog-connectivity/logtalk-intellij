...
INTEGER = {SIMPLE_INTEGER} ({EXPONENTIATION} {SIGN}? {SIMPLE_INTEGER})?
FLOAT = {SIMPLE_INTEGER} {DOT} {SIMPLE_INTEGER} ({EXPONENTIATION} {SIGN}? {SIMPLE_INTEGER})?
BIN_NUMBER = [0-1]+
OCT_NUMBER = [0-7]+
...
OPERATOR_SYMBOLS = {NON_COMBINABLE_OPERATOR_SYMBOLS} | {COMBINABLE_OPERATOR_SYMBOLS}+ |
    ({COMBINABLE_OPERATOR_SYMBOLS} | {DOT}) ({COMBINABLE_OPERATOR_SYMBOLS} | {DOT})+ //2 or more

//parenthesized operator symbols
PAR_OPERATOR_SYMBOLS = {NON_COMBINABLE_OPERATOR_SYMBOLS} | ({COMBINABLE_OPERATOR_SYMBOLS} | {DOT})+

SYMBOLIC_COMPOUND_NAME = ({COMBINABLE_OPERATOR_SYMBOLS} | {DOT})+ | {CUT}
